...
def get_map_json(request, **kwargs):
    ...
    location_filters = {}
    if cityParam:
        location_filters['city__name__icontains'] = cityParam
    if stateParam:
        location_filters['state__name__icontains'] = stateParam
    if countryParam:
        location_filters['country__name__icontains'] = countryParam
